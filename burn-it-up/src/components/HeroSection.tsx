    ...
    return (
        <div className="flex items-center justify-start h-screen bg-cover p-12" style={{ backgroundImage: `url(${BackgroundImage})` }}>
            ...
            <div className="flex flex-col items-center gap-6">
                {/* Orange content box */}
                <div className="bg-orange-600 bg-opacity-30 text-white p-12 rounded-lg max-w-2xl transform transition-transform duration-300 hover:scale-105 cursor-none">
                    ...
                    <p className="text-xl text-white">Unlock the power of your workouts!! Predict, Track and burn calories smarter with every move you are make.</p>
                </div>
