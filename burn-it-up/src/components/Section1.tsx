...
const SectionComponent1 = () => {
    return (
        <div className="flex justify-evenly gap-8 px-12 bg-gray-100 ">
            {/* Image 2 */}
            <div className="flex flex-col items-center bg-white p-6 rounded-lg shadow-lg w-1/3 h-[500px] transform transition-transform duration-300 hover:scale-105 cursor-none">
